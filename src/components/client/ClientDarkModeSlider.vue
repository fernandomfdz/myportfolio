    ...
    >
      <Transition>
        <div
          ...
          class="h-12 w-12 absolute left-1/2 top-0 fill-black bg-teal-200 dark:bg-teal-700 rounded-full -translate-x-[50%] -translate-y-[100%] flex items-center justify-center"
        >
        ...
        <svg class="dark:hidden size-7 text-teal-700" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
